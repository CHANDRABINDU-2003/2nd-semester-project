...
public class ForgetPass extends JFrame implements ActionListener {
    ...
    JButton search, retrieve, back; // Changed retrive to retrieve
    ...
    ForgetPass() {
        ...
        retrieve.setBounds(380, 140, 100, 25); // Changed retrive to retrieve
        retrieve.addActionListener(this); // Changed retrive to retrieve
        p1.add(retrieve); // Changed retrive to retrieve
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        } else if (ae.getSource() == retrieve) { // Changed retrive to retrieve
            try {
